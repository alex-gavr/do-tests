  ...
  return (
    <div className='flex w-full flex-row items-start justify-between gap-4'>
      <div className='flex w-full flex-col items-start justify-start gap-4'>
        ...
        <p className='text-xs tracking-widest text-slate-300 md:text-sm ml-1'>top score: {state.user.topScore}</p>
      </div>
      <div className='flex w-full flex-col items-end justify-start gap-4'>
        ...
        <p className='text-xs tracking-widest text-slate-300 md:text-sm mr-1'>
          {' '}
