const dictionary = {
  ...
  ShoppingSurvey: {
    welcome: {
      title: 'รับ <strong> พิเศษ </strong> ข้อตกลงการช็อปปิ้งหลังจากเสร็จสิ้นการสำรวจ',
      paragraph: 'เราได้ร่วมมือกับแบรนด์อีคอมเมิร์ซชั้นนำเพื่อมอบของขวัญพิเศษให้คุณ',
      button: 'เริ่ม',
    },
    thankYou: {
      title: 'ขอบคุณ!',
  ...
  CountDown: {
    freeAccess: 'การเข้าถึงฟรีสิ้นสุดใน',
