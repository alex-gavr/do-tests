const dictionary = {
  ...
  ShoppingSurvey: {
    welcome: {
      title: 'Dapatkan penawaran belanja <strong>eksklusif</strong> setelah menyelesaikan survei',
      paragraph:
        'Kami telah bekerja sama dengan merek e-commerce terkemuka untuk menyediakan Anda hadiah khusus',
      button: 'MULAI',
    },
    thankYou: {
      title: 'Terima Kasih!',
      ...
      shoppingReviews: [
        {
          ...
          winImages: ['/images/shoppingReviews/id/female1.webp'],
        },
        {
          id: 2,
          ...
          winImages: ['/images/shoppingReviews/id/female2.webp'],
        },
        {
          id: 3,
          ...
          winImages: ['/images/shoppingReviews/id/female3.webp'],
        },
        {
          id: 4,
          title: 'Wow!',
          ...
          winImages: ['/images/shoppingReviews/id/female4.webp'],
        },
        {
          id: 5,
          ...
          winImages: ['/images/shoppingReviews/id/male1.webp'],
        },
        {
          id: 6,
          title: 'Diskon yang Tidak Terduga',
          ...
          winImages: ['/images/shoppingReviews/id/male2.webp'],
        },
      ],
    },
  },
